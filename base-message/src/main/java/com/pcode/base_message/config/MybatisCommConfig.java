package com.pcode.base_message.config;
...
import static com.pcode.base_message.config.MybatisSessionFactory.createSqlSessionFactory;


@Slf4j
@Configuration
@MapperScan(basePackages = "com.pcode.base_message.dao", sqlSessionFactoryRef = "commSqlSessionFactory")
